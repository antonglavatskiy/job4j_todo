...
class HQLTaskRepositoryTest {
    ...
    public void whenSaveTasksThenGetListAll() {
        ...
        Task task1 = taskRepository.save(new Task(0, "task1", creationDate.minusHours(2), false));
        Task task2 = taskRepository.save(new Task(0, "task2", creationDate.minusHours(1), false));
        Task task3 = taskRepository.save(new Task(0, "task3", creationDate, false));
    ...
    public void whenSaveTasksThenGetListNew() {
        LocalDateTime creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        Task task1 = taskRepository.save(new Task(0, "task1", creationDate.minusHours(13), false));
        Task task2 = taskRepository.save(new Task(0, "task2", creationDate.minusHours(6), false));
        Task task3 = taskRepository.save(new Task(0, "task3", creationDate, false));
    ...
    public void whenSaveTaskThenCheckStatus() {
        LocalDateTime creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        Task task = taskRepository.save(new Task(0, "task", creationDate, false));
    ...
    public void whenSaveTasksThenGetListDone() {
        LocalDateTime creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        Task task1 = taskRepository.save(new Task(0, "task1", creationDate, false));
        Task task2 = taskRepository.save(new Task(0, "task2", creationDate.plusHours(1), false));
        Task task3 = taskRepository.save(new Task(0, "task3", creationDate.plusHours(2), false));
    ...
    public void whenSaveTaskThenGetUpdated() {
        Task task = taskRepository.save(new Task(0, "task", LocalDateTime.now().minusHours(2), true));
        Task updatedTask = new Task(task.getId(), "new task", LocalDateTime.now(), false);
